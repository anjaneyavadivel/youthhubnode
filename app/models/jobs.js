...
// exports.getAllItems = function(done) {
//     let job_salary = 'job_salary';
//     db.get().query('SELECT * FROM job_salary', function (err, rows) {
...
//             //let pathname = req._parsedUrl.pathname.split('/');
//             //split makes an array, so pick the second row
//             let job_salary = 'job_salary';//pathname[1];
            
//             //query the DB using prepared statement
//             var results = db.query('SELECT * from ??', [job_salary], function (error, results, fields) {
//                 //if error, print blank results
//                 if (error) {
//                     // console.log(error);
//                     var apiResult = {};
